...
export const teekConfig = defineTeekConfig({
  ...
  author: {
    name: "Teeker", // 作者名称
    link: "https://github.com/yanshicheng", // 点击作者名称后跳转的链接
  },
  // 公告配置
  notice: {
  ...
  blogger: {
    ...
    avatar: "https://testingcf.jsdelivr.net/gh/yanshicheng/static/user/avatar1.png", // 博主头像
    ...
    list: [
      {
        ...
        avatar: "https://testingcf.jsdelivr.net/gh/yanshicheng/static/user/avatar2.png",
  ...
  footerGroup: [
    ...
    },
    {
      title: "内部链接",
      links: [
        { name: "快速开始", link: "/nova/quickstart" },
  ...
  appreciation: {
    ...
    options: {
      ...
      content: `<img src='/kube-nova.png'>`, // 赞赏内容，支持 HTML

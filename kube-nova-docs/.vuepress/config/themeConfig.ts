...
export default <VdoingThemeConfig>{
  ...
  repo: 'yanshicheng/yanshicheng.github.io', // 导航栏右侧生成Github链接
  searchMaxSuggestions: 10, // 搜索结果显示最大数
  lastUpdated: '更新时间', // 开启更新时间，并配置前缀文字   string | boolean (取值为git提交时间)
  docsDir: 'kube-nova-docs', // 指定根目录
  ...
  privatePage: {
    ...
    username: 'yanshicheng', // 管理员用户名
    password: 'yanshicheng@admin', // 管理员密码
  ...
  indexImg: {
    ...
    desc: [
      '旨在为运维工程师、SRE 工程师和 IT 从业人员提供一个全面的在线平台，集成工作经验积累、学习资源共享和知识记录。我们的目标是帮助用户深入了解云原生开发技术，掌握现代开发和运维最佳实践，以提高在云原生环境中的开发和管理效率。'
    ...
    icons: [
      {
        ...
        title: 'GitHub',
        link: 'https://github.com/yanshicheng'
      },
      {
        iconClass: 'icon-gitee',
        title: 'Gitee',
        link: 'https://gitee.com/yanshicheng'
      },
      {
        iconClass: 'icon-rss',
        title: '网站首页',
        link: 'https://www.yanshicheng.com'
      },
      //   {
      //     iconClass: 'icon-QQ',
      //     title: 'QQ',
      ...
      //   },
      {
        ...
        title: '联系我',
        link: 'https://www.yanshicheng.cn/?contact=true'
      }
    ]
  },
  footer

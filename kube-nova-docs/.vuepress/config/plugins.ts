...
export default <UserPlugins>[
  ...
  [
    {
      name: 'custom-plugins',
      globalUIComponents: ['PageInfo', 'BlockToggle'] // 2.x 版本, 'Twikoo' 关闭评论  时间提示 , 'Fantasy' 背景图相关 "GlobalTip" 取消 globalUIComponents 改名为 clientAppRootComponentFiles
    }
  ],
  ...
  [
    ...
    {
      hm: 'f06618722a8bed59d75788172aef88ca'
    }
  ],
  // [

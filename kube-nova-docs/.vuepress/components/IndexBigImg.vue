    ...
    methods: {
      ...
      initConfig() {
        if (this.$themeConfig.indexImg && Object.keys(this.$themeConfig.indexImg).length > 0) {
          this.navColor = this.$themeConfig.indexImg.navColor == undefined ? this.navColor : this.$themeConfig.indexImg.navColor
          this.switchNavColor = this.$themeConfig.indexImg.switchNavColor == undefined ? this.switchNavColor : this.$themeConfig.indexImg.switchNavColor
          this.bgTimeColor = this.$themeConfig.indexImg.bgTimeColor == undefined ? this.bgTimeColor : this.$themeConfig.indexImg.bgTimeColor
          this.bgTimeColorArray = this.$themeConfig.indexImg.bgTimeColorArray == undefined ? this.bgTimeColorArray : this.$themeConfig.indexImg.bgTimeColorArray
          this.descFade = this.$themeConfig.indexImg.descFade == undefined ? this.descFade : this.$themeConfig.indexImg.descFade
          this.desc = this.$themeConfig.indexImg.desc == undefined ? this.desc : this.$themeConfig.indexImg.desc
          this.descFontSize = this.$themeConfig.indexImg.descFontSize == undefined ? this.descFontSize : this.$themeConfig.indexImg.descFontSize
          this.descFadeInTime = this.$themeConfig.indexImg.descFadeInTime == undefined ? this.descFadeInTime : this.$themeConfig.indexImg.descFadeInTime
          this.descNextTime = this.$themeConfig.indexImg.descNextTime == undefined ? this.descNextTime : this.$themeConfig.indexImg.descNextTime
          this.bubble = this.$themeConfig.indexImg.bubble == undefined ? this.bubble : this.$themeConfig.indexImg.bubble
          this.bubblePosition = this.$themeConfig.indexImg.bubblePosition == undefined ? this.bubblePosition : this.$themeConfig.indexImg.bubblePosition
          this.bubbleNum = this.$themeConfig.indexImg.bubbleNum == undefined ? this.bubbleNum : this.$themeConfig.indexImg.bubbleNum
        }
      },
      // 点击箭头向下滑动
      scrollFn() {
      ...
      bgTimeColorAndTip() {
        ...
        if (hours >= 6 && hours < 11) {
          ...
          addTip(`别再熬夜了~~，现在是 ${hours}:${minutes}:${seconds}，早点睡吧，让我们一起欣赏早上的太阳~~😇🛏`, 'info', 50, 4000)
        }
